...
from trulens.providers.cortex_search import Cortex 
...
print(rag.query("what did i told you today?"))

tru_snowflake_connector = SnowflakeConnector(snowflake_session=session)
tru_session = TruSession(tru_snowflake_connector)


#evaluation
provider = Cortex(session.connection,"llama3.1-8b")
...
questions = [
    "anything about my last christmas ?",
    "what i told you about my meeting with khalti group?",
    "what's coming up next week for me?",
]
